...
- 并行融合检索 / 共享状态（Blackboard Pattern）
- 容错机制（重试 + 兜底）/ 溯源与忠实度保证
- 金融数据 Agent（行情查询）
- Plan-then-Execute 编排
- Business Compute Agent（计算 + 图表 + 报告）
"""
...
__all__ = [
    "AgentState", "FallbackReason",
    "RouterAgent", "AgentType", "RoutingDecision",
    "SearchAgent", "WebSearchAgent", "ParallelFusionController",
    "EvalAgent", "EvaluationResult",
    "RefineAgent", "RefinementResult",
    "SupervisorAgent", "FinanceDataAgent", "BusinessComputeAgent",
    "MultiAgentRAG",
    "Citation", "CitationType", "CitationManager",
    "FaithfulnessCheck", "format_answer_with_citations",
]
